import{j as t,L as h}from"./index-D_x0VcQ4.js";import{f as b}from"./formatters-CmiLqhJj.js";import{g,a as j,b as v,e as w}from"./pricing-CIeFTiJd.js";import{i as N}from"./media-DZA-bGGk.js";function _({item:s}){var i;const o=(s==null?void 0:s.name)||(s==null?void 0:s.title)||"Offer",e=(s==null?void 0:s.short_description)||(s==null?void 0:s.subtitle)||"",x=N(s,"https://picsum.photos/seed/offer/640/400"),n=g(s),a=j(s),l=a>0&&n>0&&n<a,r=l?Math.round(v(s)||(a-n)/a*100):0,f=w(s),c=(s==null?void 0:s.attraction_id)||((i=s==null?void 0:s.attraction)==null?void 0:i.id)||null,d=c?`/booking?attraction_id=${c}`:null,p=u=>u.stopPropagation();return t.jsxs("div",{className:`
