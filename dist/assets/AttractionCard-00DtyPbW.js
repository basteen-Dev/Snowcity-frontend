import{B as f,R as b,j as s,L as k}from"./index-uOjPOlE7.js";import{g as v}from"./ids-YExsbyMi.js";import{i as j}from"./media-D2Wlcy5m.js";import{g as y,a as w,b as N}from"./pricing-CIeFTiJd.js";function A({item:t}){const l=(t==null?void 0:t.name)||(t==null?void 0:t.title)||"Attraction",r=(t==null?void 0:t.short_description)||(t==null?void 0:t.subtitle)||"",x=j(t,"https://picsum.photos/seed/attr/640/400"),a=v(t),c=t!=null&&t.slug?`/${t.slug}`:a?`/attractions/${a}`:"/attractions",o=y(t,{includeOffers:!1}),e=w(t),i=o||e,d=e>0&&o>0&&o<e,g=d?Math.round(N(t)):0,u=f(),h=n=>n.stopPropagation(),p=b.useCallback(()=>{u(c)},[c,u]);return s.jsxs("div",{role:"button",tabIndex:0,onClick:p,onKeyDown:n=>{(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),p())},className:`
