...
const API_BASE_URL = import.meta.env?.VITE_API_BASE_URL || 'https://snowcity-backend-zjlj.onrender.com0';

if (!API_BASE_URL && import.meta.env?.DEV) {
  // eslint-disable-next-line no-console
  console.warn('VITE_API_BASE_URL is not set. Using default: https://snowcity-backend-zjlj.onrender.com0');
}
