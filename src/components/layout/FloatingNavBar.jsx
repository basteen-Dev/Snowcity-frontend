    ...
    <>
      ...
      <nav
        ...
        className={`fixed z-[150] transition-all duration-500 ease-in-out
          ...
          ${scrolled
            ? "bg-white md:bg-[#ffffffcc] md:backdrop-blur-xl border-b shadow-lg md:top-0 md:rounded-b-2xl md:border"
            : (isHome
              ? "bg-white md:bg-[#ffffffcc] shadow-sm md:top-2 md:rounded-2xl md:border"
              : "bg-white md:bg-[#ffffffcc] shadow-md md:top-0 md:rounded-b-xl md:border")} 
          ...
          <div className={`max-w-[1400px] mx-auto py-1 flex items-center justify-between gap-4`}>
            ...
            <div className="flex items-center gap-3 text-sm font-medium">
              ...
              <div className="relative">
                ...
                {menuOpen === "guide" && (
                  <div className="absolute right-0 top-full mt-2 w-64 rounded-lg border border-gray-200 bg-white shadow-lg p-2 z-[110]" style={{ boxShadow: '0 4px 12px rgba(0, 0, 0, 0.1)' }}>
                    <Link to="/park-timings" className="block px-4 py-2.5 text-sm text-gray-800 hover:bg-sky-100 rounded-lg transition-all duration-200 font-medium" onClick={() => setMenuOpen(null)}>Park Timings</Link>
        ...
        {mobileOpen && (
          ...
          >
            ...
            <details className="group">
              ...
              <div className="pl-4 space-y-1 mt-2 pb-3 border-t border-sky-400/20 pt-3">
                <Link to="/park-timings" className="block py-2 pl-4 text-gray-700 hover:text-black font-medium hover:bg-gray-50 rounded-lg transition-all duration-200" onClick={() => setMobileOpen(false)}>• Park Timings</Link>
