  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        ...
        <button className="rounded-md bg-gray-900 text-white px-3 py-2 text-sm" onClick={() => navigate('/permissions/new')}>New Permission</button>
      </div>
      ...
      <AdminTable
        ...
        rows={state.items}
        onRowClick={(r) => navigate(`/permissions/${r.permission_id}`)}
