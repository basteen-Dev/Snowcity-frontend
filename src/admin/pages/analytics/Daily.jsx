...
export default function Daily() {
  ...
  return (
    <div className="space-y-6">
      <SectionCard title="Daily Filters" subtitle="Slice bookings and people per day">
      ...
      <SectionCard title="Daily Bookings, People, Revenue" subtitle="Stacked trend per metric">
