      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          ...
          {state.reorder ? (
            ...
            <button className="rounded-md bg-gray-900 text-white px-3 py-2 text-sm" onClick={() => navigate('/catalog/banners/new')}>
              New Banner
            </button>
          )}
        </div>
      ...
      {!state.reorder ? (
        <>
          ...
          <AdminTable
            ...
            rows={state.items}
            onRowClick={(row) => navigate(`/catalog/banners/${row.banner_id || row.id}`)}
