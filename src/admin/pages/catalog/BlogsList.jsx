  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        ...
        <button className="rounded-md bg-gray-900 text-white px-3 py-2 text-sm" onClick={() => navigate('/catalog/blogs/new')}>
          New Blog
        </button>
      </div>
      ...
      <AdminTable
        ...
        rows={state.items}
        onRowClick={(row) => navigate(`/catalog/blogs/${row.blog_id || row.id}`)}
