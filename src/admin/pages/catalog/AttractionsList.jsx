      ...
      <PageHeader title="Attractions" subtitle="Manage your attractions catalog">
        ...
        {state.reorder ? (
          ...
          <button
            ...
            onClick={() => navigate('/catalog/attractions/new')}
          >
            + New Attraction
          </button>
        )}
      ...
      {!state.reorder ? (
        <>
          ...
          <AdminTable
              ...
              },
              {
                ...
                render: (row) => (
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      navigate(`/catalog/attraction-slots?attraction_id=${row.attraction_id || row.id}`);
                    }}
              ...
              },
              {
                ...
                render: (row) => (
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      navigate(`/catalog/attractions/${row.attraction_id || row.id}`);
                    }}
                    className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 text-sm font-medium"
                  >
                    Edit
            ...
            rows={state.items}
            onRowClick={(row) => navigate(`/catalog/attractions/${row.attraction_id || row.id}`)}
