  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        ...
        <button className="rounded-md bg-gray-900 text-white px-3 py-2 text-sm" onClick={() => navigate('/catalog/coupons/new')}>
          New Coupon
        </button>
      </div>
      ...
      <AdminTable
        ...
        rows={state.items}
        onRowClick={(row) => navigate(`/catalog/coupons/${row.coupon_id || row.id}`)}
