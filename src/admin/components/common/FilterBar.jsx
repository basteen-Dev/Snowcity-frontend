...
export default function FilterBar({
    ...
    return (
        <form
            ...
            className={`bg-white dark:bg-neutral-900 rounded-2xl border border-gray-200/80 dark:border-neutral-800 shadow-sm p-4 mb-5 ${className}`}
        >
            ...
            <div className="flex items-center gap-2 mt-3 pt-3 border-t border-gray-100 dark:border-neutral-800">
                ...
                {onReset && (
                    <button
                        ...
                        onClick={onReset}
                        disabled={loading}
                        className="rounded-lg border border-gray-300 dark:border-neutral-700 px-4 py-2 text-sm font-medium text-gray-700 dark:text-neutral-300 hover:bg-gray-50 dark:hover:bg-neutral-800 disabled:opacity-50 transition-colors"
                    >
                        Reset
                    </button>
                )}
