...
export default function Booking() {
  ...
  }, [sel.itemType, selectedCombo, selectedAttraction, selectedSlot, sel.date, state.offers]);
  ...
  const ProgressBar = () => (
    <div className="flex items-center justify-between mb-6 px-4">
      {[
        ...
        if(hasToken && s.n === 3) return null; // Skip OTP step when logged in
        ...
        <div className={`${isDesktop ? 'px-8 pt-8 pb-4 border-b border-gray-100 rounded-t-3xl bg-white' : 'sticky top-0 bg-white z-20 px-6 pt-6 pb-2 border-b border-gray-100 rounded-t-[32px]'}`}>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold text-gray-900">
              {step === 1 ? 'Select Experience' : step === 2 ? 'Customize Add-ons' : step === 3 ? 'Verify OTP' : 'Checkout'}
            </h2>
            <button 
