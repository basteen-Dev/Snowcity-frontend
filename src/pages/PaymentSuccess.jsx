          ...
          if (!conversionFiredRef.current) {
            ...
            if (!localStorage.getItem(purchaseFiredKey)) {
              ...
              window.dataLayer.push({
                ...
                currency: 'INR',
                payment_type: data?.paymentMode || data?.payment_mode || data?.gateway || '',
                payment_gateway: data?.paymentMode || data?.payment_mode || data?.gateway || '',
                selected_date: items[0]?.selected_date || '',
                time_slot:items[0]?.time_slot || '',
                has_addons: Number(data?.addonsValue || data?.addons_value || data?.addon_total || 0) > 0,
                addons_value: Number(data?.addonsValue || data?.addons_value || data?.addon_total || 0),
