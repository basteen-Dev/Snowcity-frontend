            ...
            if (data.success) {
                ...
                if (!localStorage.getItem(purchaseFiredKey)) {
                    ...
                    window.dataLayer.push({
                        ...
                        ticket_price: Number(data.ticketsValue || 0),
                        cart_value: Number(data.cartValue || 0),
                        total_value: Number(data.totalPaid || data.totalValue || data.amount || 0),
                        total_pax: items.reduce((sum, item) => sum + item.quantity, 0),
                        currency: 'INR',
                        payment_type: data.paymentMode || gateway || '',
                        payment_gateway: data.paymentMode || gateway || '',
